<template>
  <div class="container">
    <Content class="statement">
      ...
      <div class="h2">
        This Privacy Statement applies to Lofoten Arctic Water and is responsible for processing the
        company’s handling of personal information on its own website. See the contact page for
        contact information.
      </div>
      ...
      <div class="content">
        ...
        <br />
        <br />
        The privacy statement does not apply to third party websites, and Lofoten Arctic Water does
        not take responsibility for the processing of personal data on these websites.
        <br />
        <br />
        Personal information is information and assessments that can be linked to an individual. Our
        processing of personal data takes place within the framework of the general rules in the
        Norwegian Personal Data Act with regulations, as well as other relevant regulations, such as
        the Marketing Act and the Accounting Act.
        <br />
        <br />
        ...
        the specific inquiry. All inquiries are only used by Lofoten Arctic Water and are deleted no
        later than 1 year after the customer relationship has ended.
        <br />
        <br />
        Web statistics
        <br />
        Lofoten Arctic Water collects unidentified information about visitors to Google Analytics
        and Google AdSense. The purpose of this is to compile statistics that we use to improve and
        further develop the information offered on the website. Examples of what the statistics
        provide answers to are how many people visit different pages, how long the visit lasts,
        which websites the users come from and which browsers are used. The information is processed
        in deidentified and aggregated form. By deidentified is meant that we cannot trace the
        information we collect back to the individual user. We collect the entire IP address, but
        the IP address is deidentified so that only the first three groups in the address are used
        to generate statistics. That is, if the IP address consists of the numbers 195.159.103.82,
        only 195.159.103.xx is used. In addition, the IP addresses are processed at an aggregate
        level, i.e. all data is merged into a group and not processed individually.We use the
        analysis tool Google Analytics on our website. Information from this tool is not disclosed
        from Lofoten Arctic Water to other players.
        <br />
        <br />
